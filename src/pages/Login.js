...
const PassWordIcon = El({
  ...
  const PassWord = El({
    ...
    className: "flex justify-start items-center mt-5 mb-10 px-2 bg-slate-200 rounded-md",
  });
...
const FormBtn = Button({
    ...
    className: "py-3 w-full h-12 bg-[#212529] mt-72"
})
...
export default function login() {
    return El({
        ...
        className: "relative flex flex-col items-center text-center justify-center pt-32"
    })
}
